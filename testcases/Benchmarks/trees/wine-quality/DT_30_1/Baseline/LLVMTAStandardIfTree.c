						...
						if(pX[2] <= 0.20499999821186066){
							...
							if(pX[0] <= 8.849999904632568){
								if(pX[7] <= 0.9995199739933014){
									...
									if(pX[7] <= 1.0003350377082825){
										if(pX[5] <= 41.5){
											if(pX[7] <= 0.9997750222682953){
												if(pX[3] <= 16.22499942779541){
													return 4;
												} else {
													return 2;
												}
								...
								if(pX[7] <= 0.9932399988174438){
									...
									if(pX[6] <= 131.5){
										if(pX[5] <= 15.5){
											...
											if(pX[3] <= 16.299999713897705){
												if(pX[3] <= 14.324999809265137){
									...
									if(pX[5] <= 38.5){
										if(pX[6] <= 26.0){
											...
											if(pX[1] <= 0.3050000071525574){
												...
												if(pX[5] <= 32.0){
													if(pX[7] <= 0.996735006570816){
														if(pX[5] <= 22.5){
															if(pX[8] <= 3.299999952316284){
																return 2;
															} else {
																if(pX[2] <= 0.08500000275671482){
																	return 3;
																} else {
																	return 2;
																}
