				...
				if(pX[8] <=  3.3049999475479126){
					if(pX[10] >  11.75){
						if(pX[5] <=  12.5){
							...
							if(pX[7] <=  0.990559995174408){
								if(pX[1] >  0.14999999850988388){
									if(pX[7] <=  0.9895250201225281){
										return 4;
									} else {
										return 5;
									}
