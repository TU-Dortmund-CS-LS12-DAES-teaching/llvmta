					...
					if(pX[4] >  0.032500000670552254){
						if(pX[7] <=  0.9956499934196472){
							...
							if(pX[9] <=  0.5399999916553497){
								if(pX[3] >  9.775000095367432){
									if(pX[7] <=  0.9990499913692474){
