						...
						if(pX[10] <= 9.75){
							if(pX[9] <= 0.5249999761581421){
								...
								if(pX[10] > 8.949999809265137){
									if(pX[6] > 179.0){
										if(pX[7] > 0.9979050159454346){
											if(pX[3] > 14.150000095367432){
												if(pX[1] <= 0.560000017285347){
													if(pX[1] > 0.29500000178813934){
														return 2;
													} else {
														if(pX[3] <= 16.34999990463257){
															return 2;
														} else {
															return 3;
														}
						...
						if(pX[3] <= 18.024999618530273){
							if(pX[7] <= 0.9978500008583069){
								...
								if(pX[3] <= 15.575000286102295){
									...
									if(pX[7] <= 0.9996850192546844){
										return 3;
									} else {
										if(pX[2] > 0.29500000178813934){
											return 3;
										} else {
											if(pX[7] > 0.9999050199985504){
												return 2;
											} else {
												return 4;
											}
					...
					if(pX[1] <= 0.5949999988079071){
						if(pX[5] <= 16.5){
							if(pX[10] <= 11.449999809265137){
								...
								if(pX[1] > 0.2849999964237213){
									if(pX[7] > 0.9928599894046783){
										if(pX[8] <= 3.274999976158142){
											if(pX[5] <= 10.5){
												if(pX[1] <= 0.4599999934434891){
													return 3;
												} else {
													if(pX[7] <= 0.9987500309944153){
														return 4;
													} else {
														return 3;
													}
			...
			if(pX[8] > 3.0049999952316284){
				if(pX[10] <= 11.650000095367432){
					if(pX[1] <= 0.4449999928474426){
						...
						if(pX[6] <= 60.5){
							if(pX[0] <= 12.25){
								if(pX[3] <= 3.325000047683716){
									if(pX[8] <= 3.5649999380111694){
										if(pX[9] <= 1.1049999594688416){
